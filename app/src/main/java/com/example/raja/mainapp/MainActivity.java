package com.example.raja.mainapp;
...
import com.example.raja.mainapp.PnrAllData.PassengerList;
import com.example.raja.mainapp.PnrAllData.PnrData;
...
//Error! FLUSHED PNR / PNR NOT YET GENERATED
                            if (p.getMessage().getBoardingPoint() == null) {
                                Toast.makeText(MainActivity.this, "Error! FLUSHED PNR / PNR NOT YET GENERATED", Toast.LENGTH_SHORT).show();
                            }
...
//MainPnrData object created
                                MainPnrData mainpnrdata = new MainPnrData();
...
//Setting Adapter for Passenger list
                                ...
                                passengerList.setAdapter(new PnrPassengerListAdapter(MainActivity.this, passengerlist));
                            }
                        }
                    },
                    ...
                    final StringRequest request = new StringRequest(URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            if (response != "") {
                             ...
                             try{   MainPnrData mainpnrdata = new MainPnrData();
                                mainpnrdata.setResponse(response);
                                mainpnrdata.setMainlist();
